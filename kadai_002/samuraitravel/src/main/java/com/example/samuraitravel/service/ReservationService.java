...
public class ReservationService {
    ...
    @Transactional
    public void create(Map<String, String> paymentIntentObject) {  //paymentIntentObjectは支払い情報のメタデータが含まれているオブジェクトで、get()メソッドにメタデータ名を渡すことでその値を取得することができる
    ...
    public Integer calculateAmount(LocalDate checkinDate, LocalDate checkoutDate, Integer price) {
        ...
        return amount;
    }  //ChronoUnit.DAYS.between()メソッドを使い、2つの日付（LocalDate型）の間の日数、つまり宿泊日数を計算
